...
Used in Planning Phase 4: Decomposition. Beads are stored in the bd database (`.beads/issues.jsonl`). Always use `bd` commands as the source of truth.
...
**Result**: 1 epic + 3 issues with proper dependencies.
